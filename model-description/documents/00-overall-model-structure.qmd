...
+ **Farmer age distribution** shows the distribution of farmer ages (this is mostly a check to make sure it is not changing much).
+ **Debt** is histogram showing the distribution of farmer debt asset ratios (total debt outstanding debt to estimated value of farm).
