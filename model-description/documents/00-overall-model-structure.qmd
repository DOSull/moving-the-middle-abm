...
### 3. Model parameters
Most model parameters are included in a set of files (described on [this page](00b-model-files.qmd)). Controls immediately to the right of the map area are as follows:
