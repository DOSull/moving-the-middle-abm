...
### Scale
Model grid cells represent 400&times;400 meter (16 hectare) areas. Model time steps represent 5 years of elapsed time.
...
### Farms
Farms don't _do_ much of anything since [holdings](#holdings) were added to the model. This is reflected in the fact that their only attributes are the self-explanatory `the-land`, `farm-type`, and `my-farmer`. Farms do also keep track of the aggregate profit, income, and costs of all the holdings that compose the farm, but calculation of these amounts happens at the holding level. Farms also carry debt represented in their `total-loans`, `current-debt`, `debt-repayments`, `debt-maturity`, and `dsr` (debt service ratio) attributes.
...
| 2025-10-17 | Updated for version including debt.
