...
`intervention-details`          | _Impact of interventions_ on costs, yields, capital costs, and the various environmental metrics, by landuse; _initial proportions_ of holdings of each landuse on which intervention should be implemented at model initialisation; a _maximum proportion_ for each of these on each landuse type reflecting possible obstacles to implementation.
