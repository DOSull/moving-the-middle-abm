...
#### Random geography
Random initialisation first sets up a land use capability (LUC) landscape using iterative smoothing[^3], then randomly distributes farmers across the landscape assigning them a farm based on Voronoi polygons[^4] and breaking the farm into sub-farm level holdings based on contiguouse areas of the same LUC.
