...
In any case, this parameterisation keeps the farmer age distribution fairly stable over time. 
...
A new farmer will consider whole-farm landuse change (see [Farmer decisions about land use](04-farmer-decisions-land-use.qmd) for details) **under conditions to be determined but related to recent profitability and the debt status of the incoming farmer**. This pathway to land use is more likely to lead to land use change at the whole farm level than the more piecemeal changes that tend to be made by incumbent farmers.
