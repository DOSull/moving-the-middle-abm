...
Each of these parameters may depend on the [farm type](00a-model-elements.qmd#land-use) $F$ and the land use capability (LUC), $L$, such that the full calculation of profit for each hectare of a holding is
